    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          final role = state.extra as String? ?? 'arrendador';
          return PhoneVerificationScreen(role: role);
        },
      ),
      GoRoute(
        path: '/home',
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return ListingDetailScreen(index: idStr);
        },
      ),
      GoRoute(
        path: '/publish',
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return PropertyReviewsScreen(targetUserId: targetUserId);
        },
      ),
    ],
