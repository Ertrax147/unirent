...
import '../../../listing/presentation/providers/reviews_provider.dart';
  ...
  Future<void> _submitReview() async {
    ...
    try {
      ...
      await apiClient.post('/reviews', {
        ...
        // timestamp is generated in the backend
      });
      ...
      // Refrescar las estadísticas y lista de reseñas
      ref.invalidate(userReviewsProvider(widget.otherUserId));
      ref.invalidate(userReviewStatsProvider(widget.otherUserId));
    } catch (e) {
