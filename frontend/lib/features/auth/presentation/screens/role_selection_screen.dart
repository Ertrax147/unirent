...
class _RoleSelectionScreenState extends ConsumerState<RoleSelectionScreen> {
  ...
  void _handleContinue() async {
    ...
    if (_selectedRole == 'arrendador') {
      // Go to MFA / Verification, passing the role
      if (mounted) context.go('/mfa', extra: _selectedRole);
    } else {
      // It's a student, register immediately (they don't need phone verification)
      await ref.read(authStateProvider.notifier).registrarUsuario(_selectedRole!, '');
